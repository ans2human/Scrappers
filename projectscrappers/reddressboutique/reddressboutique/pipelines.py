...
class ReddressboutiquePipeline(object):
    ...
    def _conditional_insert(self, tx, item):
        ...
        if result:
            ...
            tx.execute("insert into products (producturl, price, productname, invcount,  prodcategory, productsizes, productcolor) values (%s, %s, %s, %s, %s, %s, %s)", [ item['producturl'], item['price'], item['productname'], item['invcount'], item['prodcategory'], item['productsizes'], item['productcolor'] ])
